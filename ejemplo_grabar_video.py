...
cap = cv2.VideoCapture(r'inputs\tirada_1.mp4')  # Abre el archivo de video especificado ('tirada_1.mp4') para su lectura.
...
out = cv2.VideoWriter(r'outputs\Video-Output.mp4', cv2.VideoWriter_fourcc(*'mp4v'), fps, (width,height))
